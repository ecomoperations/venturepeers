...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { body: @tutorial.body, functionality: @tutorial.functionality, language: @tutorial.language, suggestion: @tutorial.suggestion, title: @tutorial.title }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { body: @tutorial.body, functionality: @tutorial.functionality, language: @tutorial.language, suggestion: @tutorial.suggestion, title: @tutorial.title }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
